...
{\centering \includegraphics{Data_Analysis_Phase1_files/figure-latex/sentiment-bar-1} 
...
{\centering \includegraphics{Data_Analysis_Phase1_files/figure-latex/sentiment-platform-plot-1} 
...
{\centering \includegraphics{Data_Analysis_Phase1_files/figure-latex/time-plot-1} 
...
{\centering \includegraphics{Data_Analysis_Phase1_files/figure-latex/yearly-trend-1} 
...
{\centering \includegraphics{Data_Analysis_Phase1_files/figure-latex/monthly-heatmap-1} 
...
\section{Interactive Sentiment
Dashboard}\label{interactive-sentiment-dashboard}

The final project dashboard is available at: \textbf{{[}Link to
